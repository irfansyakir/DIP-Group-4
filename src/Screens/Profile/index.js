        ...
        <View style={styles.container}>
            ...
            <View style={styles.headerContainer}>
                ...
                <View style={styles.header}>
                    <Text style={styles.headerText}>maya</Text>
                </View>
                <View>
                ...
                <View style={styles.columnContainer}>
                    ...
                    <View style={styles.column}>
                        <Text style={styles.columnBoldText}>58</Text>
            ...
            <View style={styles.playlistContainer}>
                ...
                >   
                {renderTableRow(require('../../../assets/playlist1.png'), 'Vibing', '7 likes')}
                </TouchableOpacity>
                <TouchableOpacity
                    onPress={handleContainerClick}
                >
                {renderTableRow(require('../../../assets/playlist2.png'), 'Roadtrip', '4 likes')}
                </TouchableOpacity>
                <TouchableOpacity
                    onPress={handleContainerClick}
                >
                {renderTableRow(require('../../../assets/playlist3.png'), 'Study', '5 likes')}
                </TouchableOpacity>
            </View>
