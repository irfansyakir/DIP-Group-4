        ...
        <LinearGradient colors={["#836E55", "#4C4134", "#15120F"]} style={{ flex: 1 }}>
            <ScrollView style={{ flex: 1, marginTop: 20 }}>
                ...
                <View style={{ marginHorizontal: 10, alignItems:"center" }}>
                    <Text style={{ fontSize: 18, fontWeight: "bold", color: "white" }}> PLAYLIST NAME</Text>
                </View>

                <View style={{flexDirection:"row", alignItems:"center",justifyContent:"space-between", gap:10}}>
                    <Text style={{ fontSize: 14, color: "white" }}> Insert Description </Text>
                    ...
                    <TouchableOpacity style={{flexDirection:"row",alignItems:"center",padding:10}}>
                        ...
                        style = {{
                         ...
                         <View style={{flex:1}}>
                            ...
                            <Text style={{marginTop:4,color:"#9A9A9A"}}>{item.artist}</Text>
                         </View>

                         <View style={{flexDirection:"row", alignItems:"center",marginHorizontal:10}}>
                         <Entypo name="dots-three-horizontal" size={24} color="#ABA4A3" />
