    ...
    <View style={{flex:1, paddingTop: insets.top, backgroundColor: COLORS.dark, width: windowWidth}}>
      <ScrollView style={{ padding: 20, paddingTop:0, flex: 1, backgroundColor: COLORS.dark,}}>
        ...
        <AutocompleteDropdown
          ...
          onSubmit={() => {
            ...
            if(privateFound) {
              ...
              let theRestOfTheRoomsFound = publicRooms.concat(joinedRooms).find(element => element.id === roomCodeQuery)
        ...
        <FlatList
          ...
          renderItem={({item}) => <FlatlistRenderItem item={item} selectedRoom={selectedRoom} handleRoomSelect={handleRoomSelect} storeDisplayName={storeDisplayName} storeUserID={storeUserID} setJoinedRooms={setJoinedRooms} joinedRooms={joinedRooms} setToggleFlatlistReRender={setToggleFlatlistReRender}/>}
        />
